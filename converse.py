...
try:
    product_name = driver.find_element(By.CSS_SELECTOR, 'h1.productFullDetail-productName-6ZL.font-semibold.text-colorDefault').text
    product_price = driver.find_elements(By.CSS_SELECTOR, 'div.priceRangePdp-price-sXH')[-1].text

    product_image_url = driver.find_element(By.CLASS_NAME, 'thumbnail-rootSelected-N7k.thumbnail-root-5qJ')
