...
try:
    product_name = driver.find_element(By.CSS_SELECTOR, 'span.VU-ZEz').text
    product_price = driver.find_element(By.CSS_SELECTOR, 'div.Nx9bqj.CxhGGd').text
    product_image_url = driver.find_element(By.CLASS_NAME, 'DByuf4.IZexXJ.jLEJ7H').get_attribute('src')
